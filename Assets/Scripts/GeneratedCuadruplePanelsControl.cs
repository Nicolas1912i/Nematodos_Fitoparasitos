...
public class GeneratedCuadruplePanelsControl : MonoBehaviour
{
    ...
    [SerializeField] GameObject imageMoving_3;
    ...
    public void OpenBigImage_3()
    {
        informationPanel.SetActive(false);
        imageMoving_3.SetActive(true);
    }
